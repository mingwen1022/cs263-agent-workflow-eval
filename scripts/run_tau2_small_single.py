"""Run the tau2 retail benchmark with the small single-agent baseline (local Ollama)."""
...
def main() -> None:
    ...
    agent_config = config["agent_systems"]["small_single"]
    ...
    if run_name is None:
        ...
        run_name = f"{timestamp}_small_single_{config['domain']}_{len(task_ids)}"
