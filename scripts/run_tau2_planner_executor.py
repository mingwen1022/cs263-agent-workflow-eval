"""Run the tau2 retail benchmark with the Planner-Executor agent."""
...
def main() -> None:
    ...
    parser.add_argument("--agent-key", default="planner_executor_large")
    ...
    from cs263_agent_eval.tau2.planner_executor_agent import register_planner_executor_agent
    register_planner_executor_agent()
